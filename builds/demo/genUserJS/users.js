function Users(amountOfUsers) {
  ...
  return this.generateUsers(amountOfUsers);
}

Users.prototype.generateUsers = function (amountOfUsers) {
  this.users = [];
  if(amountOfUsers > 1){
    for (var i = 0; i < amountOfUsers; i++) {
      var indexOfUser = Math.floor((Math.random() * this.usersJson.length) + 0);
      this.users.push(this.usersJson[indexOfUser]);
    }
  }
  return this.users;
};
